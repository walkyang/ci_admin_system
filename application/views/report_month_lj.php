...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">量价-报表</strong> / <small>Report</small></div>
        </div>
        <div class="am-g">
            <div class="am-u-md-6 am-cf">
                <div class="am-fl am-cf">
                    <div class="am-btn-toolbar am-fl">
                        <form method="get" action="/report/month_lj">
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                ...
                <table class="am-table am-table-striped am-table-hover table-main">
                    <thead>
                    <tr>
                        <th class="table-title">月份</th><th class="table-type">套数</th><th class="table-date">均价</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach($deal_tj as $k=>$v){?>
                        <tr>
                            <td><?=$v->cj_year.'-'.$v->cj_month;?></td>
                            <td><?=$v->d_cnt;?></td>
