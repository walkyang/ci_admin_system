...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">中介-报表</strong> / <small>Report</small></div>
        </div>
        <div class="am-g">
            <div class="am-u-md-6 am-cf">
                <div class="am-fl am-cf">
                    <div class="am-btn-toolbar am-fl">
                        <form method="get" action="/report/month_medium">
        ...
        <div class="am-g">
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
                <thead>
                <tr>
                    <th class="table-title">中介</th><th class="table-type">套数</th><th class="table-type">环比</th><th class="table-type">成交面积(万)</th><th class="table-type">成交金额(亿)</th>
                </tr>
                </thead>
                <tbody>
                <?php foreach($medium_list as $k=>$v){
                    // 环比
                    $hb_cnt = '--';
                    foreach($pre_medium_list as $k1=>$v1){
                        if($v->short_medium_name == $v1->short_medium_name){
                            if($v1->d_cnt > 0)
